...
export default function HeroSection() {
  return (
    <section className="max-w-300 mx-auto px-10 py-20 flex flex-col items-center text-center">
      <span
      ...
      <h1
        ...
        className="text-5xl font-bold max-w-190 mb-6"
      >
      ...
      <p
        ...
        className="text-lg max-w-140 mb-10 leading-relaxed"
      >
      ...
      <div className="flex gap-4">
        <Link
          ...
          className="px-7 py-3 rounded-full text-sm font-medium hover:opacity-80 transition-opacity"
        >
          Start Your Reading
        </Link>
        <Link
